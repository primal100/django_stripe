...
from django_stripe.views import GoToSetupCheckoutView, GoToCheckoutView, GoToBillingPortalView, PaymentPortalView
...
urlpatterns = [
    ...
    re_path(r'', PaymentPortalView.as_view(), name='payment-poral'),
]
