...
urlpatterns = [
    re_path(r'^checkout/(?P<price_id>.*)/', StripePriceCheckoutView.as_view(), name="checkout"), # No slash at the end?
    re_path(r'^setup-checkout/', StripeSetupCheckoutView.as_view(), name="setup-checkout"),     # OK
    re_path(r'^billing/', StripeBillingPortalView.as_view(), name="billing"),           # OK
